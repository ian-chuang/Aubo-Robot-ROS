...
AuboDriver::~AuboDriver() {
  ...
  if (robot_connected_) {
    ROS_INFO("[AuboDriver] Disconnecting from robot.");
    disconnectRobot();
  }
}
...
void AuboDriver::connectRobot()
{
  ...
  ROS_INFO("[AuboDriver] ServiceInterface::robotServiceLogin successful.");
  ...
  ROS_INFO("[AuboDriver] ServiceInterface::robotServiceGetRobotWorkMode successful.");

  // Only call robotStartup if there is a real machine
  if (mode == aubo_robot_namespace::RobotModeReal)
  {
    ROS_INFO("[AuboDriver] Robot mode is real.");
    ...
    ROS_INFO("[AuboDriver] ServiceInterface::rootServiceRobotStartup successful, robot state: %d.", state);
  }
  else
  {
    // don't need to startup robot if in simulated mode
    ROS_INFO("[AuboDriver] Robot mode is simulated.");
  }
  ...
  ROS_INFO("[AuboDriver] Joint velocity limit set to %f", max_joint_vel_);
  ...
  ROS_INFO("[AuboDriver] Joint acceleration limit set to %f", max_joint_acc_);
...
void AuboDriver::disconnectRobot()
{
  ...
  ROS_INFO("[AuboDriver] ServiceInterface::robotServiceLogout successful.");
...
void AuboDriver::connectServoJ()
{
  ...
  ROS_INFO("[AuboDriver] ServojInterface::login successful.");
  ...
  ROS_INFO("[AuboDriver] ServojInterface::startServoj successful.");
...
void AuboDriver::disconnectServoJ()
{
  ...
  ROS_INFO("[AuboDriver] ServojInterface::stopServoj successful.");
  ...
  ROS_INFO("[AuboDriver] ServojInterface::logout successful.");
